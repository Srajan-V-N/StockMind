    ...
    return (
      <button
        className={cn(
          ...
          {
            'bg-gradient-brand text-white hover:opacity-90': variant === 'default',
            'glass-button': variant === 'glass',
            'border border-white/20 dark:border-white/10 bg-transparent hover:bg-white/10': variant === 'outline',
